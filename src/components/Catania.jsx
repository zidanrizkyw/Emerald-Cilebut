...
const Catania = () => {
    ...
    const images = [
        assets.catania1, // Ganti dengan path gambar sebenarnya
        assets.catania2, // Ganti dengan path gambar sebenarnya
        assets.catania3, // Ganti dengan path gambar sebenarnya
        assets.ametis_catania1,
        assets.ametis_catania2,
        assets.ametis_catania3,
        assets.ametis_catania4,
    ...
    return (
        <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Cluster'>
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Catania <span className='underline underline-offset-4 decoration-1 under font-light'>Cluster</span></h1>
                ...
                >
                    {images.map((image, index) => (
                        <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
                            <img src={image} className='w-full h-auto mb-14'></img>
                ...
                <div className="flex flex-col lg:flex-row justify-center gap-6 mt-14">
                    <div className="aspect-video w-full lg:w-1/2">
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/2-DWIRxWP_Y"
                    ...
                    <div className="aspect-video w-full lg:w-1/2">
                        <iframe
                            className="w-full h-full rounded-lg shadow-lg"
                            src="https://www.youtube.com/embed/-VGk_ZffbAA"
