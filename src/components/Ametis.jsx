...
const Ametis = () => {
    ...
    const images = [
        assets.ametis1, // Ganti dengan path gambar sebenarnya
    ...
    return (
        <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden'>
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Amethyst<span className='underline underline-offset-4 decoration-1 under font-light'>Type</span></h1>
            ...
            <div className='flex justify-center items-center w-full mb-10'>
                <img src={assets.catania4} className='w-full lg:w-1/2'/>
            </div>
                ...
                <div className="flex flex-col lg:flex-row justify-center gap-6 mt-14">
                    <div className="aspect-video w-full lg:w-1/2">
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/MSqFi6XlSf0"
